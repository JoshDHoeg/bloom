...
const EditButton = (props) => (
    props.edit ? (
        <button type="button" onClick={props.formSubmit} style={{ backgroundColor: "#13F2F2", marginLeft: "225px", width: "100px", height: "40px", borderRadius: "4px", boxShadow: "6px 6px 16px 0px rgba(0,0,0,0.1)"}}><Link to={ROUTES.PAYMENT_OPTIONS} style={{ textDecoration: 'none', color: "white" }} >Done</Link></button>
    ) : (
