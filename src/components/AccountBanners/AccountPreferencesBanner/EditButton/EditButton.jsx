...
const EditButton = (props) => (
    props.edit ? (
        <button onClick={props.formSubmit} type="button" style={{ backgroundColor: "#2F2FED", marginLeft: "225px", width: "100px", height: "40px", borderRadius: "4px", boxShadow: "6px 6px 16px 0px rgba(0,0,0,0.1)"}}>
            <Link to={ROUTES.ACCOUNT_PREFERENCES} style={{ textDecoration: 'none', color: "white" }} >
                Done
            </Link>
        </button>
    ) : (
