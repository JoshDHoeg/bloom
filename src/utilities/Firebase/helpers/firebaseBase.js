...
class FirebaseBase {
  ...
  doCreateUserWithEmailAndPassword = (email, password, client, name, phone, project, billadd1, zip, city, state, role, isAdmin, isEmaillist) => null; // Promise<User>
  ...
  doSetUser = (uid, name, email, phone, client, projectUid, billadd1, zip, city, state, role, isEmaillist) => null; // Promise<User> // update a user using the uid
