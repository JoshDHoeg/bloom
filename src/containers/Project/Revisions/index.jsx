...
const ClientRevisions = () => (
    <div style={{ backgroundImage: "url(" + backgroundTemp + ")", backgroundRepeat: 'repeat' }}>
        ...
        <div class="row" style={{ paddingTop: "40px" }}>
                <h1>Revisions</h1>
                <button type="button" style={{ backgroundColor: "#56CCF2", marginLeft: "380px", width: "100px", height: "40px", borderRadius: "4px", border: "#56CCF2", boxShadow: "6px 6px 16px 0px rgba(0,0,0,0.1)" }}><a href="https://drive.google.com/drive/folders/1H-aSlCfzkodqk8W7JWWv_z8L1GifTZR2?usp=sharing" style={{ textDecoration: 'none', color: "white" }}>Media</a></button>
            </div>
            <div class="row">
