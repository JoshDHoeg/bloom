            ...
            if(!this.props.approved){
                ...
                <div style={{backgroundImage: "url(" + backgroundTemp + ")", backgroundRepeat: 'repeat', marginLeft: "-14px", paddingLeft: "14px", paddingBottom: "100vh" }}>
                    <Container width="thin" text>
                        <h1 text='center'>The Draft is not approved yet.</h1>
                    </Container>
                </div>
            )
            }else{
                ...
                return (
                    <div style={{backgroundImage: "url(" + backgroundTemp + ")", backgroundRepeat: 'repeat', marginLeft: "-14px", paddingLeft: "14px", paddingBottom: "100vh" }}>
                        <Container width="thin" text>
                            <h1 text='center'>The Design Concept Is not ready yet. You will receive a notification when it is ready.</h1>
                    ...
                    <div className="ui stackable grid container">
                        <div className="row">
                            <span style={{ width: "600px" }}>
                                <h1>Your Project Final Draft Videos are Not Ready Yet...</h1>
                                <h2>Here is an example of a final draft we sent to another client so you can see what yours might look like.</h2>
                            </span>
                        </div>
                        <div className="row">
                        ...
                        <div className="row">
                            <span style={{ width: "600px" }}>
                                <h2>We will reach out to you as soon as the Final Draft for your house is ready to go!</h2>
                            </span>
                        </div>
                    </div>
                </div>
