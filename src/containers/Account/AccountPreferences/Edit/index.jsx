...
import PreferencesBanner from '../../../../components/AccountBanners/AccountPreferencesBanner'
                ...
                <div className="ui stackable grid container">
                    ...
                    <div className="row">
                        <span style={{ backGroundColor: "white", boxShadow: "6px 6px 16px 0px rgba(0,0,0,0.2)", borderRadius: "4px" }}>
                            <h1 style={{ backgroundColor: "#2F2FED", color: "white", textAlign: "center", fontSize: "15px", padding: "10px", borderTopLeftRadius: "4px", borderTopRightRadius: "4px" }}>Edit Preferences</h1>
